...
patches-own [
  ...
  is-green?       ;; boolean, indicates if patch is primarily green or not
]
...
to setup
  ...
  ask patches [
    ...
    ;; determine elevation based on input parameters
    ifelse bumpy?
       [ ifelse hill?
    ...
    set water 0
    set drain? false
    ;; determine which patches are green
    set is-green? (shade-of? (green + 2) pcolor)
  ]
